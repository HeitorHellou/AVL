...
namespace avl 
{
	...
	public: // Drawing utilities
		...
		void DrawCircle(int32_t x, int32_t y, const sf::Color& color = sf::Color::White);
		void DrawCircle(const sf::Vector2i& pos, const sf::Color& color = sf::Color::White);
		// Fills a circle at (x, y)
		void FillCircle(int32_t x, int32_t y, const sf::Color& color = sf::Color::White);
		void FillCircle(const sf::Vector2i& pos, const sf::Color& color = sf::Color::White);
		// Draws a rectangle at (x, y)
		void DrawRect(int32_t x, int32_t y, const sf::Color& color = sf::Color::White);
		void DrawRect(const sf::Vector2i& pos, const sf::Color& color = sf::Color::White);
		// Fills a rectangle at (x, y)
		void FillRect(int32_t x, int32_t y, const sf::Color& color = sf::Color::White);
		void FillRect(const sf::Vector2i& pos, const sf::Color& color = sf::Color::White);
		...
		// Draw a line of text
		void DrawString(int32_t x1, int32_t y1, const std::string& text, const sf::Color& color = sf::Color::White, uint32_t scale = 1);
